...
def newleather() -> Any:
    ...
    """
    limit = 13 if c[HARDGAME] else 15
...
def newsword() -> None:
    ...
    """
    limit = 6 if c[HARDGAME] else 13
    return nsw[rund(limit)]
